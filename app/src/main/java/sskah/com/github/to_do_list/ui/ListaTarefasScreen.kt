...
import sskah.com.github.to_do_list.util.formatarDataHora
...
fun ListaTarefasScreen(
    ...
    // Diálogo exibido sobre a própria lista (sem nova tela)
...
fun ConfirmarExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = {
            Text("A tarefa \"${tarefa.titulo}\" será excluída permanentemente. Esta ação não pode ser desfeita.")
        },
        confirmButton = {
...
@Composable
private fun ConfirmarExclusaoPreview() {
    val tarefas = listOf(
        Tarefa(id = 1, titulo = "Estudar Room", descricao = "Revisar anotações e DAO", concluida = false),
        Tarefa(id = 2, titulo = "Enviar atividade", descricao = "Upload no portal da FIAP", concluida = true)
    )
